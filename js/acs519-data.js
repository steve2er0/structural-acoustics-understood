...
export const acs519ToolCatalog = [
  ...
  { id: 'shell-acoustics', title: 'Cylindrical Shell Acoustics', category: 'Structural Acoustics', description: 'Animate the selected axial–circumferential shell shape and compare its frequency with ring, coincidence, and internal acoustic cut-on scales.', complexity: 'Advanced', keywords: ['shell modes', 'ring frequency', 'lobar', 'fairing'] },
