...
function renderTool(route){
  ...
  const context=`<section class="site-context-grid" aria-label="Calculator context">${renderLinkCollection({label:'Related concepts',items:concepts.length?concepts:calculatorRelatedLinks,variant:'related'})}${renderLinkCollection({label:'Recommended handoffs',items:handoffs,variant:'related'})}</section>`;
