...
export const engineeringWorkbenchDefinitions = [
  ...
  },
  {
    ...
    steps: [
      ...
      step('population', 'Check modal population', 'modal-density', 'Calculate structural and acoustic modes per band and overlap.'),
    ...
    syncGroups: [[link('hybrid-method-selection', 'frequency'), link('wave-matching-atlas', 'frequency'), link('modal-density', 'frequency'), link('sea-validity-confidence', 'frequency')], [link('hybrid-method-selection', 'panel_length'), link('modal-density', 'length')], [link('hybrid-method-selection', 'panel_width'), link('modal-density', 'width')], [link('hybrid-method-selection', 'thickness'), link('wave-matching-atlas', 'thickness'), link('modal-density', 'thickness'), link('fe-be-planner', 'thickness')], [link('hybrid-method-selection', 'modulus'), link('wave-matching-atlas', 'modulus'), link('modal-density', 'modulus'), link('fe-be-planner', 'modulus')], [link('hybrid-method-selection', 'density'), link('wave-matching-atlas', 'density'), link('modal-density', 'density'), link('fe-be-planner', 'density')], [link('hybrid-method-selection', 'loss_factor'), link('modal-density', 'loss_factor')]]
  },
  {
